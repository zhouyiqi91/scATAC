...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    nf-core/scatac
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Github : https://github.com/nf-core/scatac
    Website: https://nf-co.re/scatac
    Slack  : https://nfcore.slack.com/channels/scatac
----------------------------------------------------------------------------------------
*/
...
include { getGenomeAttribute      } from './subworkflows/local/utils_nfcore_scatac_pipeline'
...
workflow {
    ...
    PIPELINE_COMPLETION (
        ...
        params.monochrome_logs,
        params.hook_url,
        NFCORE_SCATAC.out.multiqc_report
    )
}
